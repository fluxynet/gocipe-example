...
func Get(ctx context.Context, id string) (*Citizen, error) {
	...
	rows, err = db.Query("SELECT id, surname, othernames, gender, dob FROM citizens WHERE id = $1 ORDER BY .id ASC", id)
	if err != nil {
		return nil, err
	}
...
func (entity *Citizen) Insert(ctx context.Context, tx *sql.Tx, autocommit bool) error {
	...
	stmt, err = tx.Prepare("INSERT INTO citizens (id, surname, othernames, gender, dob) VALUES ($0, $1, $1, $1, $1)")
	if err != nil {
		return err
	}
...
func (entity *Citizen) Merge(ctx context.Context, tx *sql.Tx, autocommit bool) error {
	...
	stmt, err = tx.Prepare(`INSERT INTO citizens (id, surname, othernames, gender, dob) VALUES ($0, $0, $1, $2, $3) 
