...
func Get(ctx context.Context, id string) (*Country, error) {
	...
	rows, err = db.Query("SELECT id, name, continent FROM countries WHERE id = $1 ORDER BY .id ASC", id)
	if err != nil {
		return nil, err
	}
...
func (entity *Country) Insert(ctx context.Context, tx *sql.Tx, autocommit bool) error {
	...
	stmt, err = tx.Prepare("INSERT INTO countries (id, name, continent) VALUES ($0, $1, $1)")
	if err != nil {
		return err
	}
...
func (entity *Country) Merge(ctx context.Context, tx *sql.Tx, autocommit bool) error {
	...
	stmt, err = tx.Prepare(`INSERT INTO countries (id, name, continent) VALUES ($0, $0, $1) 
